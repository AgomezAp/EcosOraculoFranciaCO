...
- Si vous mentionnez que vous allez révéler quelque chose sur l'animal intérieur, ${shouldGiveFullResponse
...
Réponse du guide spirituel (EN FRANÇAIS, ${isFirstMessage
                ...
                console.log(`✅ Lecture d'animal intérieur générée (${shouldGiveFullResponse ? "COMPLÈTE" : "PARTIELLE"}) avec ${usedModel} (${finalResponse.length} caractères)`);
