...
Réponse de l'astrologue (assure-toi de compléter TOUTE ton analyse zodiacale avant de terminer) :`;
                ...
                console.log(`✅ Lecture zodiacale générée avec succès avec ${usedModel} (${text.length} caractères)`);
            ...
            try {
                res.json({
                    ...
                    astrologer: {
                        ...
                        description: "Experte dans l'interprétation des caractéristiques et énergies des douze signes du zodiaque",
                        services: [
