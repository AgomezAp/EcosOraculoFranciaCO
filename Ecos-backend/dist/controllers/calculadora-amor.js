...
Réponse de l'expert en amour (EN FRANÇAIS) :`;
                console.log(`Génération d'analyse de compatibilité amoureuse (${shouldGiveFullResponse ? "COMPLÈTE" : "PARTIELLE"})...`);
                let text = "";
                let usedModel = "";
                let allModelErrors = [];
                ...
                console.log(`✅ Analyse générée (${shouldGiveFullResponse ? "COMPLÈTE" : "PARTIELLE"}) avec ${usedModel} (${finalResponse.length} caractères)`);
            ...
            try {
                res.json({
                    ...
                    loveExpert: {
                        ...
                        description: "Experte en numérologie de l'amour spécialisée dans l'analyse de compatibilité entre couples",
                        services: [
