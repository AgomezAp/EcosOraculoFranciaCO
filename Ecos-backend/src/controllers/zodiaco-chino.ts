...
Réponse de l'astrologue (assure-toi de compléter TOUTE ton analyse horoscopique avant de terminer) :`;
      ...
      console.log(
        `✅ Consultation d'horoscope générée avec succès avec ${usedModel} (${text.length} caractères)`
      );
    ...
    try {
      res.json({
        ...
        master: {
          ...
          description:
            "Sage astrologue spécialisée dans l'interprétation des influences célestes et la sagesse des douze signes zodiacaux",
          services: [
