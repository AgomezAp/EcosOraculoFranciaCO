...
Réponse de l'astrologue (EN FRANÇAIS) :`;
      ...
      console.log(
        `Génération de consultation d'horoscope (${
      ...
      console.log(
        `✅ Consultation d'horoscope générée (${
          shouldGiveFullResponse ? "COMPLÈTE" : "PARTIELLE"
...
- Si vous avez la date de naissance : ${
      isFullResponse
...
Rappelez-vous : Vous êtes une astrologue sage qui ${
      isFullResponse
        ? "révèle la sagesse complète des astres"
        : "intrigue sur les messages célestes que vous avez détectés"
    }. Parlez comme une amie sage qui veut vraiment connaître la date de naissance pour partager la sagesse des astres. ${
      isFullResponse
    ...
    try {
      res.json({
        ...
        master: {
          ...
          description:
            "Astrologue sage spécialisée dans l'interprétation des influences célestes et la sagesse des douze signes zodiacaux",
          services: [
